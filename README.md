...
Use the repository's **Orion learning goal** issue form. Keep the generated `[Orion Goal]` title prefix. The daily family council considers up to three open goals, but only when the issue was authored by the repository owner.
